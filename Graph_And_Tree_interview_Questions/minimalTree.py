# questions : - given a sorted in increasing order  array with unique intenger element write an algorithms to create a minimalTree
...
sorted_array = [i for i in range(0,101)]
a = minimalTree(sorted_array)  
a.display()